...
internal static class Program
{
    ...
    public static int Main()
    {
        ...
        using (var provider = services.BuildGeneratedServiceProvider())
        {
            ...
            // Registration through the third party's own extension method
            ...
            // Registration through the library's own extension method. Registration is ordinary MEDI behavior, and the generated factory emitted by the library's generator is adopted automatically by implementation type.
            ...
            // A type marked with [GenerateComponentFactory] resolves through the generated path even when the registration comes from another library's extension method. The diagnostic report shows the actual path (development use only).
